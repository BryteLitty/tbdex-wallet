 ...
 */
export declare function checkRequiredProperty(params: {
    property: string;
    inObject: object;
}): void;
/**
 ...
 */
export declare function checkValidProperty(params: {
    property: string;
    allowedProperties: ReadonlyArray<string> | Array<string> | Map<string, unknown> | Set<string>;
}): void;
/**
