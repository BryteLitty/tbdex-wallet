...
var SsiValidator = /** @class */ (function () {
    ...
    SsiValidator.validateContext = function (value) {
        ...
        if (input.length < 1 || input.indexOf(verifiable_credential_js_1.DEFAULT_CONTEXT) === -1) {
            throw new Error("@context is missing default context \"".concat(verifiable_credential_js_1.DEFAULT_CONTEXT, "\""));
        }
    };
