...
var Jwt = exports.Jwt = /** @class */ (function () {
    ...
    Jwt.verify = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var decodedJwt, encodedJwt, dereferenceResult, verificationMethod, publicKeyJwk, signedData, signedDataBytes, signatureBytes, isSignatureValid;
            var _a;
     ...
     */
    Jwt.didResolver = new dids_1.DidResolver({ didResolvers: [dids_1.DidDht, dids_1.DidIon, dids_1.DidKey, dids_1.DidJwk, dids_1.DidWeb] });
    return Jwt;
}());
