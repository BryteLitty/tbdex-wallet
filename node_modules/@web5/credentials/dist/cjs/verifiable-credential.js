...
exports.VerifiableCredential = exports.DEFAULT_VC_TYPE = exports.DEFAULT_CONTEXT = void 0;
...
var VerifiableCredential = /** @class */ (function () {
    ...
    VerifiableCredential.create = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var type, issuer, subject, data, issuanceDate, expirationDate, jsonData, credentialSubject, vcDataModel;
            return __generator(this, function (_a) {
                type = options.type, issuer = options.issuer, subject = options.subject, data = options.data, issuanceDate = options.issuanceDate, expirationDate = options.expirationDate;
                ...
                vcDataModel = __assign({ '@context': [exports.DEFAULT_CONTEXT], type: Array.isArray(type)
                        ? __spreadArray([exports.DEFAULT_VC_TYPE], type, true) : (type ? [exports.DEFAULT_VC_TYPE, type] : [exports.DEFAULT_VC_TYPE]), id: "urn:uuid:".concat(crypto_1.utils.randomUuid()), issuer: issuer, issuanceDate: issuanceDate || (0, utils_js_1.getCurrentXmlSchema112Timestamp)(), credentialSubject: credentialSubject }, (expirationDate && { expirationDate: expirationDate }));
