...
exports.VerifiablePresentation = exports.DEFAULT_VP_TYPE = exports.DEFAULT_CONTEXT = void 0;
    ...
    VerifiablePresentation.create = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                vpDataModel = __assign({ '@context': [exports.DEFAULT_CONTEXT], type: Array.isArray(type)
                        ? __spreadArray([exports.DEFAULT_VP_TYPE], type, true) : (type ? [exports.DEFAULT_VP_TYPE, type] : [exports.DEFAULT_VP_TYPE]), id: "urn:uuid:".concat(crypto_1.utils.randomUuid()), holder: holder, verifiableCredential: vcJwts }, additionalData);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        validatePayload(vp);
                        _i = 0, _b = vp.verifiableCredential;
                        _c.label = 2;
                    case 2:
                        if (!(_i < _b.length)) return [3 /*break*/, 5];
                        vcJwt = _b[_i];
                        return [4 /*yield*/, jwt_js_1.Jwt.verify({ jwt: vcJwt })];
                    case 3:
                        _c.sent();
                        _c.label = 4;
                    case 4:
