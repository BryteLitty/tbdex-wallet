...
export class DidIon extends DidMethod {
    ...
    static getSigningMethod({ didDocument, methodId }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const verificationMethod = (_a = didDocument.verificationMethod) === null || _a === void 0 ? void 0 : _a.find(vm => { var _a; return vm.id === (methodId !== null && methodId !== void 0 ? methodId : (_a = didDocument.assertionMethod) === null || _a === void 0 ? void 0 : _a[0]); });
