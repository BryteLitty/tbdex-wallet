...
// dist/esm/resolver/did-resolver.js
...
var DidDhtUtils = class _DidDhtUtils {
  ...
  static createBep44PutMessage({ dnsPacket, publicKeyBytes, signer }) {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      const bencodedData = import_bencode.default.encode({ seq: sequenceNumber, v: encodedDnsPacket }).subarray(1, -1);
  ...
  static parseBep44GetMessage({ bep44Message }) {
    return __awaiter5(this, void 0, void 0, function* () {
      ...
      const bencodedData = import_bencode.default.encode({ seq: bep44Message.seq, v: bep44Message.v }).subarray(1, -1);
