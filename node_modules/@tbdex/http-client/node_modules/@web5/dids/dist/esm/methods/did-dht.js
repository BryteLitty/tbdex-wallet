...
export class DidDht extends DidMethod {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const vm of verificationMethodsToAdd) {
                ...
                const keyUri = (vm.id && vm.id.split('#').pop() === '0')
                    ? identityKeyUri
                    : yield keyManager.generateKey({ algorithm: vm.algorithm });
    ...
    static import({ portableDid, keyManager = new LocalKeyManager() }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!((_a = did.document.verificationMethod) === null || _a === void 0 ? void 0 : _a.some(vm => { var _a; return ((_a = vm.id) === null || _a === void 0 ? void 0 : _a.split('#').pop()) === '0'; }))) {
    ...
    static getSigningMethod({ didDocument, methodId = '#0' }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const verificationMethod = (_a = didDocument.verificationMethod) === null || _a === void 0 ? void 0 : _a.find(vm => { var _a, _b; return extractDidFragment(vm.id) === ((_a = extractDidFragment(methodId)) !== null && _a !== void 0 ? _a : extractDidFragment((_b = didDocument.assertionMethod) === null || _b === void 0 ? void 0 : _b[0])); });
