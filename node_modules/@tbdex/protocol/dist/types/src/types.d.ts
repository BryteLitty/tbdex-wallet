 ...
 * @beta
 */
export type OfferingMetadata = ResourceMetadata & {
    kind: 'offering';
};
/**
 ...
 * @beta
 */
export type BalanceMetadata = ResourceMetadata & {
    kind: 'balance';
};
/**
 ...
 * @beta
 */
export type RfqMetadata = MessageMetadata & {
    kind: 'rfq';
};
/**
 * Quote's metadata
 * @beta
 */
export type QuoteMetadata = MessageMetadata & {
    kind: 'quote';
};
/**
 * Order's metadata
 * @beta
 */
export type OrderMetadata = MessageMetadata & {
    kind: 'order';
};
/**
 ...
 * @beta
 */
export type OrderStatusMetadata = MessageMetadata & {
    kind: 'orderstatus';
};
/**
 * Close's metadata
 * @beta
 */
export type CloseMetadata = MessageMetadata & {
    kind: 'close';
};
/**
