 ...
 * @beta
 */
export var DidResolver = new UniversalResolver({
...
export function resolveDid(did) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, didResolutionMetadata, didDocument;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, DidResolver.resolve(did)];
                case 1:
                    _a = _b.sent(), didResolutionMetadata = _a.didResolutionMetadata, didDocument = _a.didDocument;
                    if (didResolutionMetadata.error) {
                        throw new Error("Failed to resolve DID: ".concat(did, ". Error: ").concat(didResolutionMetadata.error));
                    }
