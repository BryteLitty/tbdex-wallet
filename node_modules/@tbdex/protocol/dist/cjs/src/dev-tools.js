...
var DevTools = /** @class */ (function () {
     ...
     */
    DevTools.createBalance = function (opts) {
        var _a, _b;
        return Balance.create({
            metadata: { from: (_a = opts === null || opts === void 0 ? void 0 : opts.from) !== null && _a !== void 0 ? _a : 'did:ex:pfi' },
            data: (_b = opts === null || opts === void 0 ? void 0 : opts.balanceData) !== null && _b !== void 0 ? _b : DevTools.createBalanceData()
        });
    };
    /**
     * creates an example BalanceData. Useful for testing purposes
     */
    DevTools.createBalanceData = function () {
        return {
            currencyCode: 'USD',
            available: '400.00'
        };
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, Rfq.create({
                                metadata: { from: sender.uri, to: (_a = receiver === null || receiver === void 0 ? void 0 : receiver.uri) !== null && _a !== void 0 ? _a : 'did:ex:pfi' },
                                data: rfqData
                            })];
                }
            });
