...
var Balance = /** @class */ (function (_super) {
    ...
    function Balance(metadata, data, signature) {
     ...
     */
    Balance.parse = function (rawMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var jsonMessage, balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jsonMessage = Parser.rawToResourceModel(rawMessage);
                        balance = new Balance(jsonMessage.metadata, jsonMessage.data, jsonMessage.signature);
                        return [4 /*yield*/, balance.verify()];
                    case 1:
                        _a.sent();
     ...
     */
    Balance.create = function (opts) {
        var _a;
        var metadata = __assign(__assign({}, opts.metadata), { kind: 'balance', id: Resource.generateId('balance'), createdAt: new Date().toISOString(), protocol: (_a = opts.metadata.protocol) !== null && _a !== void 0 ? _a : '1.0' });
        var balance = new Balance(metadata, opts.data);
