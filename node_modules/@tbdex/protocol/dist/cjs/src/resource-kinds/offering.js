...
var Offering = /** @class */ (function (_super) {
    ...
    function Offering(metadata, data, signature) {
     ...
     */
    Offering.parse = function (rawMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var jsonMessage, offering;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jsonMessage = Parser.rawToResourceModel(rawMessage);
                        offering = new Offering(jsonMessage.metadata, jsonMessage.data, jsonMessage.signature);
                        return [4 /*yield*/, offering.verify()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, offering];
                }
            });
        });
    };
    ...
    Offering.create = function (opts) {
        var _a;
        var metadata = __assign(__assign({}, opts.metadata), { kind: 'offering', id: Resource.generateId('offering'), createdAt: new Date().toISOString(), protocol: (_a = opts.metadata.protocol) !== null && _a !== void 0 ? _a : '1.0' });
        var offering = new Offering(metadata, opts.data);
