...
var OrderStatus = /** @class */ (function (_super) {
     ...
     */
    OrderStatus.parse = function (rawMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var jsonMessage, orderStatus;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jsonMessage = Parser.rawToMessageModel(rawMessage);
                        orderStatus = new OrderStatus(jsonMessage.metadata, jsonMessage.data, jsonMessage.signature);
                        return [4 /*yield*/, orderStatus.verify()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, orderStatus];
                }
            });
        });
    };
    ...
    OrderStatus.create = function (opts) {
        var _a;
        var metadata = __assign(__assign({}, opts.metadata), { kind: 'orderstatus', id: Message.generateId('orderstatus'), createdAt: new Date().toISOString(), protocol: (_a = opts.metadata.protocol) !== null && _a !== void 0 ? _a : '1.0' });
        var orderStatus = new OrderStatus(metadata, opts.data);
