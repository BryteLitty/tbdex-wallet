...
var Quote = /** @class */ (function (_super) {
    ...
    function Quote(metadata, data, signature) {
     ...
     */
    Quote.parse = function (rawMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var jsonMessage, quote;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jsonMessage = Parser.rawToMessageModel(rawMessage);
                        quote = new Quote(jsonMessage.metadata, jsonMessage.data, jsonMessage.signature);
                        return [4 /*yield*/, quote.verify()];
                    case 1:
                        _a.sent();
    ...
    Quote.create = function (opts) {
        var _a;
        var metadata = __assign(__assign({}, opts.metadata), { kind: 'quote', id: Message.generateId('quote'), createdAt: new Date().toISOString(), protocol: (_a = opts.metadata.protocol) !== null && _a !== void 0 ? _a : '1.0' });
        var quote = new Quote(metadata, opts.data);
        quote.validateData();
        return quote;
    };
    return Quote;
