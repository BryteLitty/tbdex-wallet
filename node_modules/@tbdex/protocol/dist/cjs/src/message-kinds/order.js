...
var Order = /** @class */ (function (_super) {
     ...
     */
    Order.parse = function (rawMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var jsonMessage, order;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jsonMessage = Parser.rawToMessageModel(rawMessage);
                        order = new Order(jsonMessage.metadata, jsonMessage.data, jsonMessage.signature);
                        return [4 /*yield*/, order.verify()];
                    case 1:
                        _a.sent();
    ...
    Order.create = function (opts) {
        var _a;
        var metadata = __assign(__assign({}, opts.metadata), { kind: 'order', id: Message.generateId('order'), createdAt: new Date().toISOString(), protocol: (_a = opts.metadata.protocol) !== null && _a !== void 0 ? _a : '1.0' });
        var order = new Order(metadata, {});
        order.validateData();
        return order;
    };
    return Order;
