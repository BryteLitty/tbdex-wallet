...
var Close = /** @class */ (function (_super) {
    ...
    function Close(metadata, data, signature) {
     ...
     */
    Close.parse = function (rawMessage) {
        return __awaiter(this, void 0, void 0, function () {
            var jsonMessage, close;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jsonMessage = Parser.rawToMessageModel(rawMessage);
                        close = new Close(jsonMessage.metadata, jsonMessage.data, jsonMessage.signature);
                        return [4 /*yield*/, close.verify()];
                    case 1:
                        _a.sent();
     ...
     */
    Close.create = function (opts) {
        var _a;
        var metadata = __assign(__assign({}, opts.metadata), { kind: 'close', id: Message.generateId('close'), createdAt: new Date().toISOString(), protocol: (_a = opts.metadata.protocol) !== null && _a !== void 0 ? _a : '1.0' });
        var close = new Close(metadata, opts.data);
        close.validateData();
        return close;
    };
    Object.defineProperty(Close.prototype, "reason", {
